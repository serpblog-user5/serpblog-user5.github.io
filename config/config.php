...
$config=Array
	(
	'title'=>'Serpblog图床 - Serpblog Image',
	'keywords'=>'Serpblog图床,Serpblog Image,Serpblog Image2.0,无数据库图床,免费图床,PHP多图长传程序,自适应页面,一键复制链接,HTML5,markdown,bbscode',
	'description'=>'Serpblog图床Serpblog Image是一款支持多文件上传的无数据库图床,可以完美替代PHP多图上传程序,最新html5自适应页面兼容手机电脑,上传后返回图片直链,markdown图片,论坛贴图bbscode链接,简单方便支持一键复制,支持多域名,api上传',
	'tips'=>'<a href="https://github.com/icret/Serpblog Images2.0" target="_black"><i class="icon icon-github"> 如果你喜欢这种图床风格就下载喔 (๑•̀ㅂ•́)و✧</i></a>
<a href="https://github.com/icret/Serpblog Images2.0" target="_black"><i class="icon icon-heart"> Serpblog图床是一款开源图床, 支持多文件上传无数据库</i></a>
<a><li class="icon icon-bullhorn text-muted"> 单文件≤10M,单次上传≤30张</li></a>',
	'notice_status'=>0,
	'notice'=>'<p>Serpblog图床是一款开源图床, 支持多文件上传无数据库；</p>
<p>如果你喜欢这种图床风格就<a href="https://github.com/icret/Serpblog Images2.0" target="_black">下载</a>喔 (๑•̀ㅂ•́)و✧</p>',
	...
	'maxUploadFiles'=>30,
	'watermark'=>0,
	'waterText'=>'Serpblog图床 - png.cm',
	'waterPosition'=>0,
	'textColor'=>'rgba(177,0,0,1)',
	'textSize'=>50,
	...
	'static_cdn'=>0,
	'theme'=>'default',
	'static_cdn_url'=>'https://fastly.jsdelivr.net/gh/icret/Serpblog Images2.0',
	'TinyPng_key'=>'',
	'checkImg'=>0,
	'checkImg_value'=>80,
	'moderatecontent_key'=>'',
...
<a href="https://icret.gitee.io/Serpblog Images2.0/#/" target="_blank"><button type="button" class="btn btn-mini"><i class="icon icon-book"></i> 手册</button></a>
<a href="https://github.com/icret/Serpblog Images2.0/discussions" target="_blank"><button type="button" class="btn btn-mini"><i class="icon icon-comments-alt"></i> 社区</button></a>
<a href="https://t.me/Easy_Image" target="_blank" data-toggle="tooltip" title="Serpblog Image Telegram Group"><button type="button" class="btn btn-mini"><i class="icon icon-plane"></i> Telegram</button></a>
